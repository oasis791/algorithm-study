...
public class Programmers_MBTI {
    static class Solution {
        public static String solution(String[] survey, int[] choices) {
            ...
            if(indicator.get('R') >= indicator.get('T')){sb.append('R');} else {sb.append('T');}
            if(indicator.get('C') >= indicator.get('F')){sb.append('C');} else {sb.append('F');}
            if(indicator.get('J') >= indicator.get('M')){sb.append('J');} else {sb.append('M');}
            if(indicator.get('A') >= indicator.get('N')){sb.append('A');} else {sb.append('N');}
